...
/**
 * icons.php
 * Small reusable inline SVG icon library.
 * Include this file, then call icon('name') to output an <svg>.
 * Icons use currentColor so their color is set purely by CSS —
 * no internet/CDN dependency, works fully offline.
 */
...
function icon(string $name): string
{
    $icons = [
        ...
        'senior' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21v-1a8 8 0 0 1 16 0v1"/></svg>',
        ...
        'report' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6"/><path d="M9 13h6"/><path d="M9 17h6"/></svg>',
